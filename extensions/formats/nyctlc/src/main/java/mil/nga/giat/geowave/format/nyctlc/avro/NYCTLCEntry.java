			...
			org.apache.avro.data.RecordBuilder<NYCTLCEntry>
	{
		...
		public NYCTLCEntry build() {
			try {
				...
				record.pickup_longitude = fieldSetFlags()[5] ? this.pickup_longitude : (java.lang.Double) defaultValue(fields()[5]);
				record.pickup_latitude = fieldSetFlags()[6] ? this.pickup_latitude : (java.lang.Double) defaultValue(fields()[6]);
				record.rate_code_id = fieldSetFlags()[7] ? this.rate_code_id : (java.lang.Integer) defaultValue(fields()[7]);
				record.store_and_fwd_flag = fieldSetFlags()[8] ? this.store_and_fwd_flag : (java.lang.Boolean) defaultValue(fields()[8]);
				record.dropoff_longitude = fieldSetFlags()[9] ? this.dropoff_longitude : (java.lang.Double) defaultValue(fields()[9]);
				record.dropoff_latitude = fieldSetFlags()[10] ? this.dropoff_latitude : (java.lang.Double) defaultValue(fields()[10]);
				record.payment_type = fieldSetFlags()[11] ? this.payment_type : (java.lang.Integer) defaultValue(fields()[11]);
				record.fare_amount = fieldSetFlags()[12] ? this.fare_amount : (java.lang.Double) defaultValue(fields()[12]);
				...
				record.tip_amount = fieldSetFlags()[16] ? this.tip_amount : (java.lang.Double) defaultValue(fields()[16]);
				record.tolls_amount = fieldSetFlags()[17] ? this.tolls_amount : (java.lang.Double) defaultValue(fields()[17]);
				record.total_amount = fieldSetFlags()[18] ? this.total_amount : (java.lang.Double) defaultValue(fields()[18]);
				record.trip_type = fieldSetFlags()[19] ? this.trip_type : (java.lang.Integer) defaultValue(fields()[19]);
				record.ehail_fee = fieldSetFlags()[20] ? this.ehail_fee : (java.lang.Double) defaultValue(fields()[20]);
				record.time_of_day_sec = fieldSetFlags()[21] ? this.time_of_day_sec : (java.lang.Long) defaultValue(fields()[21]);
