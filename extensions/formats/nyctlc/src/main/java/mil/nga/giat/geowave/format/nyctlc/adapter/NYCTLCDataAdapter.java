		...
		FeatureDataAdapter
{
	...
	protected void init(
		...
		final AttributeDescriptor pickupDescriptor = type.getDescriptor(NYCTLCUtils.Field.PICKUP_LOCATION.getIndexedName());
		...
		final AttributeDescriptor dropoffLonDescriptor = type.getDescriptor(NYCTLCUtils.Field.DROPOFF_LOCATION.getIndexedName());
		dimensionMatchingFieldHandlers.put(
