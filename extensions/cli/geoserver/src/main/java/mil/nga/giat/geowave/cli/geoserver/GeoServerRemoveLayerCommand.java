...
@GeowaveOperation(name = "rmlayer", parentOperation = GeoServerSection.class)
@Parameters(commandDescription = "Remove GeoServer Layer")
public class GeoServerRemoveLayerCommand implements
		Command
{
	...
	public void execute(
		...
		Response deleteLayerResponse = geoserverClient.deleteLayer(layerName);
