...
@GeowaveOperation(name = "list", parentOperation = GeoServerSection.class)
@Parameters(commandDescription = "List GeoServer layers")
public class GeoServerListLayersCommand implements
		Command
{
	...
	@Parameter(names = {
		"-g",
		"--geowaveOnly"
	}, required = false, description = "Show only GeoWave layers (default: false)")
